        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              <h1 className="text-lg lg:text-xl font-semibold text-gray900">
                {" "}
                MfuraStore{" "}
              </h1>
              <h1 className="text-lg lg:text-xl text-gray-900 opacity-60 pt-1">
                Casul puff Sleeves Solid Women White Top
              </h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6">
                <p className="font-semibold">rwf199</p>
                <p className="opacity-50 line-through">rwf211</p>
                <p className="text-green-600 font-semi-bold">5% off</p>
              </div>
        ...
        <Grid item xs={5}>
            ...
            <Grid container alignItems="center" gap={2}>
              <Grid item xs={2} >
                ...
                <Grid item xs={7}>
                <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4, height:7, color:"yellow"}}variant="determinate" value={20}  />
